...
public class ReservationDaoImpl extends ApplicationDaoImpl<ReservationEntity> implements ReservationDao {
  ...
  public PaginatedListTo<ReservationEntity> findReservations(ReservationSearchCriteriaTo criteria) {
    ...
    query.where(Alias.$(reservation.getIdUser()).eq(idUser));
    ...
    int reservationType = criteria.getReservationType();
    query.where(Alias.$(reservation.getReservationType()).eq(reservationType));
    long idTable = criteria.getIdTable();
    query.where(Alias.$(reservation.getIdTable()).eq(idTable));
