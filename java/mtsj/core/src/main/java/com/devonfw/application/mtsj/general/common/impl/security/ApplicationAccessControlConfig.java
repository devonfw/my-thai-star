...
/**
 * This class configures access control objects for authorization.
 * To be used with {@link RolesAllowed} annotation.
 */
@Named
public class ApplicationAccessControlConfig extends AccessControlConfig {
	...
	public ApplicationAccessControlConfig() {
		super();
		AccessControlGroup waiter = group(GROUP_WAITER, PERMISSION_FIND_CATEGORY, PERMISSION_DELETE_CATEGORY, PERMISSION_SAVE_CATEGORY);
	}
