...
FROM "OASP_TEST"."ORDERLINE" AS "ORDERLINE"
JOIN "OASP_TEST"."ORDERS" AS "ORDERS" ON "ORDERLINE"."IDORDER" = "ORDERS"."ID"
JOIN "OASP_TEST"."BOOKING" AS "BOOKING" ON "BOOKING"."ID" = "ORDERS"."IDBOOKING"
...
JOIN "OASP_TEST"."ORDERS" AS "ORDERS" ON "ORDERLINE"."IDORDER" = "ORDERS"."ID"
JOIN "OASP_TEST"."BOOKING" AS "BOOKING" ON "BOOKING"."ID" = "ORDERS"."IDBOOKING"
JOIN "OASP_TEST"."DATEINFO" AS "DATEINFO" ON TO_VARCHAR("DATEINFO"."DATE", 'YYYY-MM') = TO_VARCHAR("BOOKING"."BOOKINGDATE", 'YYYY-MM')
...
CREATE VIEW OrderedDishesPerDay AS SELECT
  ...
  "DAILYORDEREDDISHES".*
FROM "OASP_TEST"."DAILYORDEREDDISHES" AS "DAILYORDEREDDISHES"
JOIN "OASP_TEST"."DISH" AS "DISH" ON "DAILYORDEREDDISHES"."IDDISH" = "DISH"."ID"
JOIN "OASP_TEST"."DATEINFO" AS "DATEINFO" ON TO_VARCHAR("DATEINFO"."DATE", 'YYYY-MM-DD') = TO_VARCHAR("DAILYORDEREDDISHES"."BOOKINGDATE", 'YYYY-MM-DD');
...
FROM "OASP_TEST"."MONTHLYORDEREDDISHES" AS "MONTHLYORDEREDDISHES"
JOIN "OASP_TEST"."DISH" AS "DISH" ON "MONTHLYORDEREDDISHES"."IDDISH" = "DISH"."ID";
