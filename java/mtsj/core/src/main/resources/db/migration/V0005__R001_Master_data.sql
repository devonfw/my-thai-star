...
INSERT INTO User(id, modificationCounter, username, password, twoFactorStatus, email, idRole) VALUES (3, 1, 'cook', '{bcrypt}$2a$10$NwpJKhs/3UFHAOWGZhbRW.33Eb.usBOEr4w73gYbyo7a1OD1doIGe', false, 'cook@mail.com', 3);
INSERT INTO User(id, modificationCounter, username, password, twoFactorStatus, email, idRole) VALUES (4, 1, 'barkeeper', '{bcrypt}$2a$10$8T0JB1c1sWCaClSVBHbP4us38Tg/5j.B.C4T0MJWjQU8CjSGqHuam', false, 'barkeeper@mail.com', 4);
INSERT INTO User(id, modificationCounter, username, password, twoFactorStatus, email, idRole) VALUES (5, 1, 'chief', '{bcrypt}$2a$10$hfYO45o.cIT0OtGJfNlIJ.l945JECKeEKEy3RxS0cI8jA90YDIpA.', false, 'chief@mail.com', 5);
