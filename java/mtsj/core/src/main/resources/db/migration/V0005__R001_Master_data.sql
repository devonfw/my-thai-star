...
INSERT INTO User(id, modificationCounter, username, password, secret, usingtwofactor, email, idRole) VALUES (2, 1, 'manager', '{bcrypt}$2a$10$IsTlZemkiPKE2gjtnSMlJOX5.uitNHXNRpLYyvyxNbHEhjpY.XdTq', 'KBJROASFZWPIASJE', true, 'manager@mail.com', 2);
