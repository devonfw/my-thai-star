...
public class UsermanagementRestServiceTest {
  ...
  void saveUser() {
    ...
    UserDto userEto = UserDto.builder().username("TestUser").email("testuser@cg.com").twoFactorStatus(false)
        .userRoleId(1L).build();
  ...
  void findUsersByPost() {
    ...
    UserSearchCriteriaDto userSearchCriteriaTo = UserSearchCriteriaDto.builder().email("user0@mail.com").build();
