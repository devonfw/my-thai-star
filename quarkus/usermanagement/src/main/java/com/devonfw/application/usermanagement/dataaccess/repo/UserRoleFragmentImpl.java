...
import com.devonfw.application.usermanagement.dataaccess.QUserRoleEntity;
...
public class UserRoleFragmentImpl implements UserRoleFragment {
  ...
  @Override
  public Page<UserRoleEntity> findRolesByCriteria(UserRoleSearchCriteriaTo searchCriteria) {
