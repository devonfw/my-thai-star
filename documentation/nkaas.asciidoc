...
Finally, the applications should be available at my-thai-star.demo.xpaas.io. The `my-thai-star` ist specified in the MTS link:https://github.com/devonfw/my-thai-star/blob/develop/jenkins/nKaaS/ingress.yaml[ingress] configuration at `host`. The `demo.xpaas.io` is the address of the nKaaS you're working on.
