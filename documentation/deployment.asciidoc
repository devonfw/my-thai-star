...
NOTE: My thai star deployed in Okteto cloud environment. URL: https://mts-devonfw-core.cloud.okteto.net/ Refer the link:okteto-deployment.asciidoc[deployment guide] to understand the steps to deploy in Okteto cloud.
