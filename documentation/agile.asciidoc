...
The team aligned on having two weekly Stand up meetings instead of a Daily `Standup` meeting. In comparison with the time boxed length of 15 mins described in the CAF for this project the team extended the `Standup` meeting to 30 mins. The content of the meetings remains the same.
