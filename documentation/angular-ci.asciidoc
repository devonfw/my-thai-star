...
- *src-Dir*: Directory where you store the source code. For angular applications the default value is `src`
+
...
- *globalSettings-Id*: The id of the global settings file.
+
