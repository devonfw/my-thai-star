...
- *registry Url*: The URL to the docker registry where the image is stored.
- *registry Credentials Id*: Credentials to publish/download images from registry.
- *docker Network*: Network of your My Thai Star application. You can deploy several versions of MTS in the same server by changing the dockerNetwork.
- *VERSION*: The version that you can to deploy.
...
- *docker Network*: Network of your My Thai Star application. You can deploy several versions of MTS in the same server by changing the port and the dockerNetwork.
- *VERSION*: The version that you can to deploy.
