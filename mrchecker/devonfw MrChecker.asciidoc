...
Notice that one of the pages this test is using, _ThaiHomePage_ needs the Url you have MyThaiStar running, so change the Url in *settings.properties*, inside _src/resources_.
...
== Using MrChecker in a custom project

To be able to create end-to-end tests using MrChecker's Selenium Module, you will first need to add the following dependencies into your POM file:
...
After that, you can proceed as explained previously, creating a folder for pages and another folder for tests.