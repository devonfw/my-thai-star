...
/* @export
 * @class BookTableDialogComponent
 * @implements {OnInit}
 */
@Component({
...
export class BookTableDialogComponent implements OnInit {
  ...
  /* Creates an instance of BookTableDialogComponent.
   * @param {SnackBarService} snackBar
   * @param {BookTableService} bookingService
   * @param {TranslateService} translateService
   * @param {MatDialogRef<BookTableDialogComponent>} dialog
   * @param {*} dialogData
   * @memberof BookTableDialogComponent
   */
  constructor(
  ...
  sendBooking(): void {
    this.bookingService
      .postBooking(this.bookingService.composeBooking(this.data, 0))
      .subscribe(
        () => {
